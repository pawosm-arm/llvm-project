...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      nxv1i16        = 114,  // n x  1 x i16
      nxv2i16        = 115,  // n x  2 x i16
      nxv4i16        = 116,  // n x  4 x i16
      nxv8i16        = 117,  // n x  8 x i16
      nxv16i16       = 118,  // n x 16 x i16
      nxv32i16       = 119,  // n x 32 x i16

      nxv1i32        = 120,  // n x  1 x i32
      nxv2i32        = 121,  // n x  2 x i32
      nxv4i32        = 122,  // n x  4 x i32
      nxv8i32        = 123,  // n x  8 x i32
      nxv16i32       = 124,  // n x 16 x i32
      nxv32i32       = 125,  // n x 32 x i32

      nxv1i64        = 126,  // n x  1 x i64
      nxv2i64        = 127,  // n x  2 x i64
      nxv4i64        = 128,  // n x  4 x i64
      nxv8i64        = 129,  // n x  8 x i64
      nxv16i64       = 130,  // n x 16 x i64
      nxv32i64       = 131,  // n x 32 x i64
